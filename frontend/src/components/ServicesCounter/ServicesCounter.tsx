...
const ServicesCounter:FC = () => {
    ...
    return (
        <div className={'flex-col sm:flex-row justify-center gap-10 sm:gap-10 bg-white border-[1px] w-fit border-accent-4 rounded-md shadow-md py-3 px-7 absolute z-10 ml-20 hidden sm:flex'}>
