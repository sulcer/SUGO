      ...
      >
        <div className={'flex flex-row gap-3 sm:w-1/3 group'}>
          ...
          <div className={'flex flex-col mt-0.5'}>
            ...
            <p className='text-sm text-gray-500 group-hover:text-tint-2 transition ease-in-out delay-150 duration-300'>Prilagajanje individualnim željam in potrebam naših strank. Odlikujeta nas odzivnost in hitra izvedba naročil.</p>
          </div>
        </div>
        ...
        <div className={'flex flex-row gap-3 sm:w-1/3 group'}>
          ...
          <div className={'flex flex-col mt-0.5'}>
            ...
            <p className='text-sm text-gray-500 group-hover:text-tint-2 transition ease-in-out delay-150 duration-300'>Dosegamo vrhunsko kvaliteto storitev in izdelkov, ki so obdelani pri nas na tehnološko dovršenih strojih v lastni proizvodnji.</p>
          </div>
        </div>
        <div className={'w-full h-[1px] sm:h-32 sm:w-[1px] bg-accent-4'} />
        ...
        <div className={'flex flex-row gap-3 sm:w-1/3 group'}>
          ...
          <div className={'flex flex-col mt-0.5'}>
            ...
            <p className='text-sm text-gray-500 group-hover:text-tint-2 transition ease-in-out delay-150 duration-300'>Precizna strojna izdelava in obdelava izdelkov, ki jih odlikujejo bogate dolgoletne izkušnje ter strokovnost našega kadra.</p>
          </div>
        </div>
      </div>
    </div>
